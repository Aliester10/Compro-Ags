...
@section('content')
    ...
    @php
        ...
        // Add the categories query for product dropdown
...
<style>
    ...
    /* Product dropdown styling - ADDED */
    #product-container {
        position: relative;
    }
    ...
    /* Product dropdown content styling */
    ...
    /* Mobile responsive for product dropdown */
    @media (max-width: 768px) {
        #product-dropdown {
            position: static;
            transform: none;
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Product dropdown functionality for mobile only - ADDED
    ...
    <nav class="absolute top-0 left-0 right-0 z-10 p-10 bg-transparent transition-all duration-300" id="mainNav">
        <div class="flex items-center justify-between relative navbar-content" id="navbarContent">
            ...
            <ul class="md:flex md:items-center z-10 md:z-auto md:static absolute bg-gray-800 md:bg-transparent w-full left-0 md:w-auto md:py-0 py-4 md:pl-0 pl-7 md:opacity-100 opacity-0 top-[-400px] transition-all ease-in duration-500">
                ...
                <!-- Modified Product menu with dropdown -->
                                ...
                                <div class="product-dropdown-column">
                                    @foreach($kategoriChunk as $kategori)
                                        <div class="product-dropdown-category">
                                            <a href="{{ route('member.product.category', ['id' => $kategori->id]) }}" class="product-dropdown-category-title" style="display: block; text-decoration: none; color: #000000 !important;">
                                                {{ $kategori->nama }}
                                            </a>
